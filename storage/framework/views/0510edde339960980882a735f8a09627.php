...
<div class="max-w-[720px] mx-auto py-32 sm:py-8 lg:py-16">
  ...
  <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
      <div>
          ...
          <p class="text-slatce-500">A list of all the supplier account..</p>
      </div>
      <div class="ml-3">
  ...
  <table class="w-full text-left table-auto min-w-max">
      ...
      <tr class="hover:bg-slate-50 border-b border-slate-200">
          ...
          <td class="p-4 py-5">
          <p class="text-sm text-slate-500"><?php echo e($suplier->nama_supplier); ?></p>
          </td>
          <td class="p-4 py-5">
          <p class="text-sm text-slate-500"><?php echo e($suplier->alamat_supplier); ?></p>
          </td>
          <td class="p-4 py-5">
          <p class="text-sm text-slate-500"><?php echo e($suplier->telp_supplier); ?></p>
          </td>
          <td class="p-4 py-5">
          <p class="text-sm text-slate-500"><a href="<?php echo e(route('suplier.edit', $suplier->id)); ?>" class="font-medium text-blue-600 hover:text-blue-800">Edit</a></p>
          </td>
          <td class="p-4 py-5">
           <p class="text-sm text-slate-500">
               <a href="<?php echo e(route('suplier.destroy', $suplier->id)); ?>"
                   class="font-medium text-blue-600 hover:text-blue-800"
                   onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this supplier?')) { document.getElementById('delete-form-<?php echo e($suplier->id); ?>').submit(); }">
                    Hapus
                </a>
                <form id="delete-form-<?php echo e($suplier->id); ?>" action="<?php echo e(route('suplier.destroy', $suplier->id)); ?>" method="POST" style="display: none;">
                   <?php echo csrf_field(); ?>
...
<div class="relative flex flex-col w-full h-full justify-between items-center mt-5">
   ...
   <a href="<?php echo e(route('suplier.create')); ?>">
       Add data supplier here..
   </a>
   </button>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\supplier\resources\views/suplier/index.blade.php ENDPATH**/ ?>